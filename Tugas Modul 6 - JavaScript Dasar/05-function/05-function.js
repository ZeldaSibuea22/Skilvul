...
console.log(new Intl.NumberFormat('id-ID').format(taxCalc(4500000)));
console.log(Number(taxCalc(5000000)).toLocaleString('id-ID'));
console.log(new Intl.NumberFormat('id-ID').format(taxCalc(20000000)));
...
function convToUpperCase(sentence) {
    ...
    for (let a = 0; a < word.length; a++) {
        convert = word[a].toUpperCase();
        word[a] = convert.charAt(0) + word[a].substring(1);
    }

    let character = "";
    for (let b = 0; b < word.length; b++) {
        character = character + word[b] + " ";
    }
